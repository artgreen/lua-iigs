...
from iigsbuild.contracts import validate
...
class CompletionTests(unittest.TestCase):
    ...
    def test_generated_beacons_are_synchronized(self):
        ...
        self.assertEqual(mod.generate((ROOT / "tests/upstream/coroutine.lua").read_text()),
                         (ROOT / "tests/regression/cobeacon.lua").read_text())
