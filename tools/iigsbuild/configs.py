...
HOSTS = {
    "iigshost": {"sources": ["tests/native/iigshost.c"], "lua": True,
                 "summary": "native embedding / C-hook regression host"},
    "allocfail": {"sources": ["tests/native/allocfail.c"], "lua": True,
                  "summary": "allocator fault injection (includes lauxlib.c)"},
    "bridge": {"sources": ["examples/embedding/test.c", "examples/embedding/testiface.c", "examples/embedding/testbridge.c"], "lua": True,
               "summary": "C bridge embedding demo"},
    "mmtest": {"sources": ["tests/native/mmtest.c"], "lua": False, "summary": "raw Memory Manager probe"},
    "memfree": {"sources": ["tests/native/memfree.c"], "lua": False,
