...
Identified builds, packages, hardware kits (preserved; never rebuilt):
  ...
  make kit              identify + test + package

  make release BUILD=<dir> REPORT=<report.json>  assemble a local release candidate

Cleanup:
  make clean            remove only build/dev and build/test-runs
                        identified builds, packages, reports, and dist are preserved
